...
config_h_in = src/vlfeat_examples_config.h.in
...
clean:
	@rm -rf m4 src/*.lo src/*.la src/*.o src/*.a src/.libs src/.deps src/Makefile src/Makefile.in src/stamp-h1 src/vlfeat_examples_config.h*
